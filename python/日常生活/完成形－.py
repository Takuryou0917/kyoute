...
class CalendarApp:
    ...
    def create_widgets(self):
        ...
        self.calendar = Calendar(self.root, selectmode="day", year=2025, month=1, day=1, font=("Arial", 18),
                                 background="#3a3a3a", foreground="#ffffff", borderwidth=2,
                                 normalbackground="#2e2e2e", normalforeground="#ffffff",
                                 headersbackground="#444444", headersforeground="#ffffff",
                                 selectbackground="#007acc", selectforeground="#ffffff",
                                 weekendbackground="#ff6666")
